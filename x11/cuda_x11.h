...
extern void x11_cubehash512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t *d_hash, int order);
...
extern void x11_simd512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t *d_hash, int order);
